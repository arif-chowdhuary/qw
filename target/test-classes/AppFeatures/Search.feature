...
@Smoke
 Scenario: Search a Product MAcBook air
	 ...
	 Then Your order id is 12345 and username is "Arif"

@Regression 
 Scenario: Search a Product Iphone
	 Given I have a search field on Amazon Page
	 When I search for a product with name "Iphoneo" and Price 700
	 Then Product with name "Iphone" should be displayed
	 Then Your order id is 09876 and username is "Chowdhuary"